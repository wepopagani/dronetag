    ...
    >
      ...
      <div
        ...
        className={classNames(
          ...
          'max-h-[min(92dvh,100dvh)] sm:max-h-[min(85dvh,40rem)]',
      ...
      >
        ...
        <div className="flex shrink-0 items-start justify-between gap-3 border-b border-gray-100 px-4 py-3 sm:px-6 sm:py-4">
          <h2 id={titleId} className="min-w-0 flex-1 pr-1 text-sm font-semibold leading-snug text-gray-900 sm:text-lg">
            {title}
          </h2>
          <button
            type="button"
