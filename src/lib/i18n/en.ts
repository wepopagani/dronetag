...
export const translations = {
  ...
  'signup.otp.title': 'Verify your contact',
  'signup.otp.subtitle': 'Enter the OTP codes to confirm your email and/or phone. At least one channel must be verified.',
  'signup.otp.gateSubtitle': 'You must verify at least your email or phone before accessing your account.',
  'signup.otp.chooseChannels': 'How would you like to verify?',
  'signup.otp.verifyEmailOption': 'Verify email (OTP code)',
  'signup.otp.verifyPhoneOption': 'Verify phone (SMS OTP)',
  'signup.otp.channelHint': 'Choose at least one method. You can select both.',
  'signup.otp.channelRequired': 'Select at least email or phone to verify.',
  'signup.otp.phoneRequired': 'Enter your phone number for SMS verification.',
  'signup.otp.emailSection': 'Email verification',
  'signup.otp.phoneSection': 'Phone verification',
  'signup.otp.sendEmail': 'Send code by email',
  'signup.otp.sendPhone': 'Send code by SMS',
  'signup.otp.resend': 'Resend code',
  'signup.otp.codeLabel': '6-digit code',
  'signup.otp.verify': 'Verify',
  'signup.otp.verified': 'Verified',
  'signup.otp.continue': 'Continue',
  'signup.otp.errorSend': 'Could not send the code. Please try again.',
  'signup.otp.errorCode': 'Invalid or expired code.',
  'signup.otp.errorPhone': 'Invalid phone number.',
  'signup.otp.errorIncomplete': 'Complete verification for all selected channels.',
  'signup.otp.devCode': 'Dev: email code {code}',
  ...
  'permits.list.subtitle': 'Dedicated space for operational authorizations. Planned limit: 5 MB.',
  'permits.list.new': 'New permit',
  'permits.list.empty': 'No permits uploaded',
  'permits.list.emptyDesc': 'Permits, authorizations and operational documents verified by the parser will appear here.',
  'permits.hint.parser': 'Parser: flight area, conditions, dates and drone',
  'permits.hint.storage': 'Dedicated space: 5 MB',
  'permits.hint.admin': 'Admins can always verify manually',

  'archive.list.title': 'Archive',
  'archive.list.subtitle': 'Purchasable document archive. Planned limit: 30 MB.',
  'archive.list.new': 'Upload to archive',
  'archive.list.empty': 'Archive is empty',
  'archive.list.emptyDesc': 'Historical documents, expired policies and replaced certificates will be stored here.',
  'archive.hint.storage': 'Archive space: 30 MB',
  'archive.hint.autoMove': 'Expired versions can move here automatically',
  'archive.hint.upgrade': 'Archive space will be purchasable from the shop',
