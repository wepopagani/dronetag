...
export const translations = {
  ...
  // ── Sign-up form ──
  'signup.title': 'Sign up for DroneTag',
  'signup.subtitle': 'Create your digital operator identity — profile, certificates, insurance, and drones in one place.',
  ...
  // ── Login page ──
  'login.title': 'Sign in to DroneTag',
  'login.subtitle': 'Access your profile, documents, certificates, and drones.',
  ...
  'home.nav.adminArea': 'Admin area',
  'home.nav.openDashboard': 'Open dashboard',

  'home.hero.eyebrow': 'DIGITAL IDENTITY FOR UAS OPERATORS',
  'home.hero.title': 'All your drone credentials, always available.',
  'home.hero.subtitle': 'DroneTag brings operator profile, certificates, insurance, and drones into one digital identity accessible via NFC badge and the official app.',
  'home.hero.ctaPrimary': 'Access the platform',
  'home.hero.ctaSecondary': 'See how it works',
  'home.hero.ctaDashboard': 'Go to dashboard',
  'home.hero.trustNfc': 'Quick NFC access',
  'home.hero.trustDocs': 'Protected documents',
  'home.hero.trustExpiry': 'Expiry tracking',

  'home.preview.operatorName': 'Marco Bianchi',
  'home.preview.operatorRole': 'UAS operator \u00b7 AeroFly Srl',
  'home.preview.insurance': 'Liability insurance',
  'home.preview.insuranceDetail': 'Policy valid until Dec 2026',
  'home.preview.certificate': 'Certificate A2',
  'home.preview.certificateDetail': 'Open category \u2014 subcategory A2',
  'home.preview.drone': 'Registered drone',
  'home.preview.droneDetail': 'DJI Mavic 3 \u00b7 IT-DRN-4821',
  'home.preview.valid': 'Valid',
  'home.preview.expiring': 'Expiring',
  'home.preview.showCredentials': 'Show credentials',
  'home.preview.nfcDetected': 'Badge detected',
  'home.preview.nfcSuccess': 'Profile opened successfully',

  'home.audience.operator.title': 'I am an operator',
  'home.audience.operator.desc': 'View and share certificates, insurance, and linked drones.',
  'home.audience.operator.cta': 'Access profile',
  'home.audience.admin.title': 'I am an administrator',
  'home.audience.admin.desc': 'Manage users, verifications, documents, badges, and expiries.',
  'home.audience.admin.cta': 'Open admin area',
  'home.audience.verifier.title': 'I need to verify an operator',
  'home.audience.verifier.desc': 'View the public profile via NFC, QR, or link.',
  'home.audience.verifier.cta': 'Open verification',

  'home.how.title': 'How it works',
  'home.how.step1.title': 'Create your profile',
  'home.how.step1.desc': 'Register operator, organization, and drones.',
  'home.how.step2.title': 'Upload credentials',
  'home.how.step2.desc': 'Add certificates, insurance, and documents.',
  'home.how.step3.title': 'Share when needed',
  'home.how.step3.desc': 'Share the profile via NFC badge, QR, or link.',

  'home.features.title': 'Core features',
  'home.features.subtitle': 'Everything you need to manage drone operator identity and compliance in one place.',
  'home.features.profile.title': 'Operator profile',
  'home.features.profile.desc': 'Identity, roles, and professional data.',
  'home.features.certificates.title': 'Certificates',
  'home.features.certificates.desc': 'A1/A3, A2, STS, and other qualifications.',
  'home.features.insurances.title': 'Insurance',
  'home.features.insurances.desc': 'Policies, validity, and linked documents.',
  'home.features.drones.title': 'Drones',
  'home.features.drones.desc': 'Identification data, status, and associations.',
  'home.features.nfc.title': 'NFC badge & official app',
  'home.features.nfc.desc': 'Instant access to the digital profile.',
  'home.features.expiry.title': 'Expiry monitoring',
  'home.features.expiry.desc': 'Alerts for expiring or missing documents.',

  'home.nfc.title': 'From badge to digital profile in one tap.',
  'home.nfc.subtitle': 'Hold a smartphone near the NFC badge or scan the QR code to open the operator\u2019s verifiable profile.',
  'home.nfc.benefit1': 'No app required',
  'home.nfc.benefit2': 'Instant access',
  'home.nfc.benefit3': 'Public and protected data kept separate',
  'home.nfc.scanHint': 'Public verification page',

  'home.verify.title': 'Built for quick checks.',
  'home.verify.subtitle': 'Authorities and clients can read the essentials in seconds \u2014 without digging through folders.',
  'home.verify.point1': 'Verified operator status at a glance',
  'home.verify.point2': 'Active insurance and certificates listed',
  'home.verify.point3': 'Protected documents available on request',
  'home.verify.operatorId': 'ID DT-2024-0847',
  'home.verify.rowInsurance': 'Insurance',
  'home.verify.rowCertificates': 'Active certificates',
  'home.verify.certificatesValue': 'A1/A3, A2',
  'home.verify.rowUpdated': 'Last updated',
  'home.verify.updatedValue': '19 Jun 2026',
  'home.verify.viewProtected': 'View protected documents',
  'home.verify.footerNote': 'Public data only \u2014 sensitive documents require authorization.',

  'home.ctaFinal.title': 'Keep your credentials with you.',
  'home.ctaFinal.subtitle': 'Sign in to DroneTag and manage profile, documents, certificates, and drones from one platform.',

  'home.footer.desc': 'Private digital identity and document management for UAS operators.',
  ...
  'legal.platformDisclaimer': 'DroneTag is a private digital identification and document management platform. It does not replace registrations, certifications, or documentation issued by competent authorities.',
